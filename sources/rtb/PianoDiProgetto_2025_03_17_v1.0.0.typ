...
L'intero progetto è scandito da due macro-fasi fondamentali,  corrispondenti alle principali revisioni del progetto:
  ...
  + *PB (Product Baseline)*
   - Le attività previste per questa fase verranno incluse dopo il completamento della fase di RTB#apice("G").
...
1. *Incremento 1: Sistema di Simulazione GPS Funzionante: * 
    ...
    - *Implementazioni: *   
      ...
      - Infrastruttura containerizzata con Docker#apice("G")
...
2. *Incremento 2: Dashboard di Visualizzazione e Monitoring: *
   ...
   - *Implementazioni: *
    ...
    - Pipeline ETL#apice("G") per elaborazione dati
...
3. *Incremento 3: Sistema di Analytics e Database Integration: *
    ...
    - *Implementazioni: *
      ...
      - Integrazione Grafana per analytics#apice("G")
...
4. *Incremento 4: Sistema Production-Ready per P.o.C. :*
   ...
   - *Implementazioni: *
      ...
      - Visualizzazione real-time#apice("G") in Grafana#apice("G")
      - Integrazione metriche per servizi API#apice("G")
      - Configurazione production-ready#apice("G") validata

5. *Incremento 5: Stream Processing Real-Time:*
   - *Analisi:* Ottimizzazione architettura per eliminazione consumer tradizionale e introduzione stream processing real-time
   - *Progettazione:* Pipeline event-driven con elaborazione dati in tempo reale
   - *Implementazioni: *
      - Stream processing per elaborazione tempo reale
...
==== Pianificazione
Il tredicesimo periodo rappresenta la fine ufficiale del periodo RTB. Il gruppo ha stabilito di effettuare un controllo finale della documentazione e del P.o.C. in vista della revisione RTB.
