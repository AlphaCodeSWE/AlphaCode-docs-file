...
#show: bubble.with(
  ...
  version: "1.0.0",
  version_history: (
    "1.0.0", "2025-04-08", "Stesura del verbale", "Alessandro Di Pasquale","Romeo Calearo",
  ),
...
- *Luogo*: Chiamata Google Meet, piattaforma usata dall'azienda Sync Lab;
- *Ora di inizio*: 17:00;
- *Ora di fine*: 17:50;
...
L'incontro è stato fortemente guidato dall'azienda che ci ha fornito tutte le informazioni necessarie a fornire una panoramica di progetto più approfondita, con particolare attenzione nel definire lo stack tecnologico di cui il gruppo potrà avvalersi per la realizzazione del progetto.
...
== Documenti
L'azienda ha chiesto espressamente di fornire un'anteprima dei documenti realizzati, dotati di changelog, e in generale, di comunicare eventuali dubbi a tempo debito così da poter agire per tempo su ipotetici problemi o difficoltà.

== Primi passi
Si richiede, entro il 2025-04-17, di aver concluso almeno una parte significativa della prima frazione di progetto assegnata al gruppo, ovvero il primo incremento : un docker compose con un simulatore di dati streaming e un message broker.
