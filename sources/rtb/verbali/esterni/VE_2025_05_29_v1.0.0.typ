...
#show: bubble.with(
  ...
  roles: (
      ...
      "", "Manuel Cinnirella",
      "Validatori", "Alessandro Di Pasquale",
      "", "Nicolò Bovo"
  ),
  author: "AlphaCode",
  ...
  version_history: (
    ...
    "Nicolò Bovo, Elia Leonetti, Giovanni Battista Matteazzi, Massimo Chioru",
  ),
...
- Proposta di incontri in presenza per presentazione P.o.C.

== Aggiornamento lavoro pregresso
- Perfezionamento documentazione mancante;

== Consigli ricevuti
Durante l'incontro l'azienda ha risposto ad alcuni dubbi circa il pattern architetturale più adatto al progetto, anticipando un argomento caratteristico della fase di PB. 
Inoltre è stata valutata una possibile presentazione in sede del P.o.C. come fase intermedia prima di procedere con la fase PB. 
...
#align(center,
  table(
    ...
    align(center)[ORG], [AlphaCode Full Team], align(left)[Prossimo incontro con Sync Lab S.r.l. fissato per il 2025/06/12 alle 15:00],
