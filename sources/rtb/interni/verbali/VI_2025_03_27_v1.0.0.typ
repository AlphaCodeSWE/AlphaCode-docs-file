...
#show: bubble.with(
  ...
  version: "1.0.0",
  version_history: (
    "1.0.0", "2025/03/27", "Stesura del verbale", "Manuel Cinnirella, Nicolò Bovo","Romeo Calearo",
  ),
...
La riunione si è aperta con la lettura e la presa d'atto dell'aggiudicazione del capitolato C4; è stato pertanto deciso di fissare un secondo incontro con l'azienda per iniziare a entrare nel merito del lavoro da svolgere. La consegna del progetto è fissara prudenzialmente al 15 agosto 2025 con un costo conforme pari a 12.635 euro. Successivamente il gruppo ha discusso e introdotto per la metologia operativa il framework Scrum come modalità principale di gestione e sviluppo del progetto. È emersa, tuttavia, la necessità di definire un criterio chiaro per la rotazione dei ruoli tra i membri del team: si procede ad un cambio ogni due settimane. In merito alla gestione della reposity, il team ha riscontrato un buon metodo nel versionamento e un'organizzazione complessiva discreta. Si è deciso di procedere alla stesura delle _Norme di progetto_, con l'obiettivo di fornire una guida operativa per il team. Infine, particolare attenzione è stata rivolta alla gestione dei verbali e alla registrazione delle decisioni. Pur riconoscendo una buona capacità di sintesi e organizzazione dei verbali, si è evidenziato una criticità: l'assenza di un metodo per la tracciabilità delle decisioni prese. È stato così concordato di introdurre un sistema di gestione decisionale per documentare in modo efficace e traccibile ogni decisione presa, sfruttando cosi la sezione _Projects_ e le _Issues_ presenti su github. 
...
- A breve, una volta sistemata la reposity, non sarà più possibile apportare modifiche direttamente sul ramo principale dei repository, ogni aggiornamento dovrà passare tramite una richiesta di pull (pull-request) e sarà validato da un membro differente (verificatore) o dal responsabile.
