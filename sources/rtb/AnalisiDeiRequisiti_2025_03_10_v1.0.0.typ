...
=== Riferimenti tecnici
- Docker#apice("G") Compose: `docker-compose.yml`
- Configurazione ambiente: `.env`
- Documentazione API#apice("G"): FastAPI#apice("G") autodocs (`/docs`)
- Database schema: Script di inizializzazione ClickHouse#apice("G") e PostgreSQL

=== Riferimenti implementativi
- Repository GitHub del progetto
- Dockerfile e script di deployment
- Configurazioni di monitoraggio (Grafana#apice("G"), Prometheus#apice("G"))
...
*Streaming Data Pipeline#apice("G"):*
- *Apache Kafka*: Message broker#apice("G") per streaming eventi GPS con SSL
- *Bytewax*: Stream processor#apice("G") per elaborazione real-time con supporto multi-worker
